...
5. **Organizations** — companies, products, teams, or institutions explicitly named in the document (e.g. the company that authored it, partners, competitors, platforms mentioned). Include the document's own issuing organization if identifiable.

Be selective and concise. Extract the TOP 5-8 most important sections (not every paragraph). Concepts should be domain-specific terms that matter for understanding — not generic words. Limit to 5-10 key concepts. Section content should be a 2-3 sentence SUMMARY, not the full text. Organizations: limit to 1-5 most important named entities.
...
Organization types: "company", "product", "team", "institution", "platform".`;
