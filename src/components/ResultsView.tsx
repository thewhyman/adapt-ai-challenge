    ...
    <div className="animate-fade-in">
      ...
      {activeTab === "content" && (
        <div className="glass-panel rounded-2xl p-8 sm:p-10 animate-fade-in">
          <article className="prose prose-invert max-w-none text-[15px] leading-[1.6] [&>*]:my-2 [&>h2]:text-lg [&>h2]:mt-5 [&>h2]:mb-2 [&>h3]:text-base [&>h3]:mt-4 [&>h3]:mb-1 prose-headings:text-zinc-50 prose-headings:font-semibold prose-p:text-zinc-300 prose-strong:text-zinc-100 prose-li:text-zinc-300 prose-a:text-indigo-400 prose-blockquote:border-indigo-500/30 prose-blockquote:text-zinc-400 prose-code:text-indigo-300 prose-code:bg-indigo-500/10 prose-code:px-1 prose-code:rounded prose-code:text-sm prose-hr:border-white/[0.06]">
